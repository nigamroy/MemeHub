...
#ifndef MEME_APP_SWIFT_H
#define MEME_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="meme_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8meme_app11AppDelegate")
...
SWIFT_CLASS("_TtC8meme_app17MainFlutterWindow")
